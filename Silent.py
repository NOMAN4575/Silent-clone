...
def banner():
	print(f"""
\x1b[1;91m┏───────────────────────────────────────────────────────────┓
\x1b[1;91m│\033[47m\033[1;31m                ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ anisur ᴡᴏʀʟᴅ                 \033[40m\033[00m\x1b[1;91m│
\x1b[1;91m┠────────••••••••••••••••••••••••••••••••••••••••••••••••••
  ╔════════════════════════════════════════╗
    ║[•] Author    : MD ANISUR RAHMAN
    ║[•] Facebook page  :  ITS ANIS
    ║[•] Whatsapp  : +8801942992904
    ║[•] Github    : github.com/anisur143
    ║[•] Status    : FREE                                 ║[•] whatsapp group: TERMUX FREE COMMAND
    ║[•] Version   : 1.0.5                                ║[•] Tools     : PUBLIC clone
    ╚════════════════════════════════════════╝
••••••••••••••••••••••••••••••••••••••••••••••••••─┯─────────┯─────────┯────────┯─────────┯──────────┫
\x1b[1;91m│ 
\x1b[1;91m┠─────────┷─────────┷─────────┷─┬──────┷─────────┷──────────┫
\x1b[1;91m│\x1b[1;91m❲\x1b[1;92m◍\x1b[1;91m❳ \x1b[1;96mᴅᴇᴠᴏʟᴏᴘᴇʀ\x1b[1;91m: \033[47m\033[1;34mmd anisur \033[40m\033[00m       \x1b[1;91m│\x1b[1;96m● \x1b[1;91mɴᴏᴛᴇ:\x1b[1;92mᴛʜɪs ᴛᴏᴏʟs ɪs ᴘᴀɪᴅ \x1b[1;96m●\x1b[1;91m│
\x1b[1;91m┠───────────────────────────────╂───────────────────────────┫
